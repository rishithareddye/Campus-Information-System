...
<head>
   ...
   <link rel="stylesheet" href="../students/css/styles.css" />
   <link rel="stylesheet" href="../students/css/resp.css" />
   <script src="http://code.jquery.com/jquery-latest.min.js" type="text/javascript"></script>
   <link rel="icon" href="favicon.ico" type="image/x-icon" />
<link rel="shortcut icon" href="../images/favicon.ico" type="image/x-icon" />
   <script src="../students/js/script.js"></script>
...
<ul>
  ...
  <li class='<?php if($pagename==="complaints.php")echo "active"; ?>'><a href='scomp.php'>Complaints</a></li>
